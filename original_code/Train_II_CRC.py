...
def main(args):
    ...
    print('batch_size=',batch_size, ' Remainder of the dataset:', len(train_dataset) % bb, len(val_dataset) % bb, len(test_dataset) % bb)
    ...
    for epoch in range(args.epochs):
        ...
        if epoch % 20 == 0:
            print('The previous best result, Best_epoch=', Best_epoch, Test_cidx)
...
if __name__ == '__main__':
    ...
    task = 'cox'
    Dir = os.path.join(r'your_path', i)
